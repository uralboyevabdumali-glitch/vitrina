import { Search, Sun, Moon, ShoppingCart, Bell, ChevronDown } from "lucide-react";
  ...
  return (
    <header className="h-16 flex items-center justify-between px-6 border-b border-zinc-200 dark:border-zinc-900 bg-white dark:bg-[#07080f]">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2 pl-3 border-l border-zinc-200 dark:border-zinc-900">
